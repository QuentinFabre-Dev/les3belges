...
namespace gestionPriseCommande
{
    public partial class menuPrincipal : Form
    {
        ...
        private void enregistrementsLivraisonsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            EnregistrementLivraison frmEnrLiv = new EnregistrementLivraison();
            frmEnrLiv.ShowDialog();
        }
    }
}
